<?php
    ...
    if(isset($_SESSION["usuario"]) && is_array($_SESSION["usuario"])){
        ...
        if($adm == 1){
            $sql_code="SELECT pedido.pedido_ID, usuario.usuario_nome, 
            pedido.pedido_rua, pedido_bairro, pedido_cidade, pedido_status,
            usuario.usuario_email, usuario.usuario_telefone FROM pedido INNER JOIN 
            usuario on pedido.pedido_usuario_ID = usuario.usuario_ID 
            WHERE usuario.adm_usuario=0 ORDER BY `pedido`.`pedido_status` ASC;";
...
<html>
    ...
    <table width="200" border="1" cellspacing="0" cellpadding="0" class="table table-bordered table-dark table-striped table-hover" >
        <tr>
            ...
            <td style="color:#b92fe1;">Status</td>
    ...
    <tr>
        ...
        <td><?php echo $row['pedido_status']; ?></td>
        <td><?php echo $row['usuario_email']; ?></td>
        <td><?php echo $row['usuario_telefone']; ?></td>
        <td>
            <a href="<?php echo $linha['usuario_nome']; ?>">Consultar</a>
